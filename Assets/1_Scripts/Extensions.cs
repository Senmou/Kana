...
public static class Extensions
{
    ...
    public static string ToMinuteSeconds(this float seconds)
    {
        return $"{TimeSpan.FromSeconds(seconds):mm\\:ss}";
    }

    public static void Print(this object text)
    {
        Debug.Log(text);
    }

    public static bool TryGetComponentInParent<T>(this Transform transform, out T comp) where T : Component
    {
        return transform.parent.TryGetComponent(out comp);
    }

    public static string WithColor(this object text, Color color)
    {
    ...
    public static string WithColor(this object text, string hex)
    {
    ...
    public static bool IsAnyLayer(this GameObject other, params string[] layers)
    {
        foreach (var layer in layers)
        {
            if (other.layer == LayerMask.NameToLayer(layer))
                return true;
        }
        return false;
    }
    ...
    public static int GetLayer(this string layerName) => LayerMask.NameToLayer(layerName);
